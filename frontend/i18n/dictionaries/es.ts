...
export const es = {
  ...
  tracking: {
    ...
    anonymous: "Anónimo",
    likedByMaker: "le gustó a quien hizo el aporte",
  ...
  notifications: {
    ...
    summary: {
      ...
      reaction: {
        ...
        tracking_record: "le gustó tu actualización de seguimiento",
  ...
  profile: {
    ...
    calendarLess: "Menos",
    calendarMore: "Más",
    calendarNone: "Sin aportes el {date}",
    calendarDayOne: "1 aporte el {date}",
    calendarDay: "{count} aportes el {date}",
