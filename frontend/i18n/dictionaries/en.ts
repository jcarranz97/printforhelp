...
export const en: Dictionary = {
  ...
  requestForm: {
    ...
    packagingLabel: "Packaging instructions (optional)",
    packagingPlaceholder:
      "e.g. Group the toys in sets of 4; each one must include the label " +
      "and QR generated by the page (Markdown supported).",
    packagingHint:
      "How to package the finished items for drop-off: grouping, labels, " +
      "QR codes, and any other guidance.",
  ...
  profile: {
    ...
    calendarLess: "Less",
    calendarMore: "More",
    calendarNone: "No contributions on {date}",
    calendarDayOne: "1 contribution on {date}",
    calendarDay: "{count} contributions on {date}",
    monthContributions: "{count} contributions",
    monthContributionsOne: "1 contribution",
    emptyActivity: "No public activity yet.",
    showMoreActivity: "Show more activity",
    loadingActivity: "Loading…",
    activityLoadError: "Couldn't load more activity. Please try again.",
    unitsPieces: "pieces",
    memberSince: "Joined",
    // Timeline summaries. `{total}` = quantity, `{unit}` = unit,
    // `{count}` = number of requests, `{request}` = request title.
    activityPrinted: "Printed {total} {unit} across {count} projects",
  ...
  settingsProfile: {
    ...
    navMoreSoon: "More tabs coming soon",
    nameLabel: "Name",
    nameHint:
      "Your name may appear around PrintForHelp where you contribute. " +
      "It's optional.",
    usernameLabel: "Username",
