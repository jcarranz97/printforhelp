...
export const en: Dictionary = {
  ...
  requestForm: {
    ...
    removeItem: "Remove",
    noParts: "Add a part to the catalog first so you can create a request.",
    submit: "Create request",
    errorRequired: "Provide a title and at least one part.",
  ...
  claim: {
    ...
    noCenters:
      "There are no verified centers available to receive drop-offs yet.",
